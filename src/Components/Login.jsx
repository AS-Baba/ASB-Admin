  ...
  return (
    <div className='container-scroller'>
        ...
        <div className="row w-100 m-0">
          <div className="content-wrapper full-page-wrapper d-flex align-items-center auth login-bg auth .auth-form-dark " style={{background:'url('+ require('./images/auth/Login_bg.jpg')+')'}} >
            <div className="card col-lg-4 mx-auto bg-dark">
              <div className="card-body px-5 py-5">
                <h3 className="card-title text-left mb-3">Login</h3>
                <form>
                  <div className="form-group">
                    <label>Username or email *</label>
                    <input type="text" className="form-control p_input bg-dark"/>
                  </div>
                  <div className="form-group">
